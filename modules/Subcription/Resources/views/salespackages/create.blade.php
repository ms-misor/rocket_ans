                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="text-end">
                                <a href="{{ route('salespackages.index') }}"  class="btn btn-success btn-sm mr-1"><i class="fas fa-list mr-1"></i>Package List</a>
                            </div>
                        </div>
                    </div>
                        <form action="{{ @$package ? route('salespackages.update',$package->id) : route('salespackages.store') }}" method="POST">
                            @csrf
                            @if(@$package)
                                @method('PATCH')
                            @endif
                                ...
                                <div class="card col-md-6 row">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="mt-3 row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input class="form-control" type="number" id="price" name="price" value="{{ @$package->price }}" placeholder="Enter Price">
                                                        @if($errors->has('price'))
                                ...
                                <div class="card col-md-6 row">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" type="number" id="offer_price" name="offer_price" value="{{ @$package->offer_price }}" placeholder="Enter Offer Price">
                                                </div>
                                            </div>
                                            <div class="mt-3 row">
                                            ...
                                            <div class="mt-3 row">
                                                <label for="duration" class="col-sm-3 col-form-label">Offer Start Date</label>
                                                <div class="col-sm-8">
