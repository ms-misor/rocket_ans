        ...
        <div class="row">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 fw-semi-bold mb-0">Sales Pricing Plan</h6>
                    </div>
                    <div class="text-end">
                        <a href="{{ route('salespackages.create') }}"  class="btn btn-success btn-sm mr-1"><i class="fas fa-plus mr-1"></i> Add New Package</a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="container">
                    <div class="row mb-4">
                        ...
                        @foreach($spackages as $key => $package)
                            ...
                            <div class="col-lg-4 mb-4">
                                ...
                                <div class="pricing-card basic-{{$key}}">
                                    ...
                                    <div class="pricing-header">
                                        ...
                                        <div class="edit-icon">
                                            <a href="{{ route('salespackages.edit', $package->id) }}" class="btn btn-sm btn-warning text-end">
